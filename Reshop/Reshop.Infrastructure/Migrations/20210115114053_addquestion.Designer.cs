...
namespace Reshop.Infrastructure.Migrations
{
    ...
    [Migration("20210115114053_addquestion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reshop.Domain.Models.User.Comment.AnswerToQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("QuestionForProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QuestionForProductId");

                    b.ToTable("AnswersToQuestion");
                });
            ...
            modelBuilder.Entity("Reshop.Domain.Models.User.Comment.QuestionForProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Reshop.Domain.Models.User.Comment.AnswerToQuestion", b =>
                {
                    b.HasOne("Reshop.Domain.Models.User.Comment.QuestionForProduct", "QuestionForProduct")
                        .WithMany("AnswersToQuestion")
                        .HasForeignKey("QuestionForProductId");

                    b.Navigation("QuestionForProduct");
                });
            ...
            modelBuilder.Entity("Reshop.Domain.Models.ProductAndCategory.Product", b =>
                {
                    ...
                    b.Navigation("QuestionsForProduct");
                });
            ...
            modelBuilder.Entity("Reshop.Domain.Models.User.Comment.QuestionForProduct", b =>
                {
                    b.Navigation("AnswersToQuestion");
                });
